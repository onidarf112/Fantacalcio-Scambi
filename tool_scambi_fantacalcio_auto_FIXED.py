...
st.set_page_config(page_title="Tool Scambi Fantacalcio - AutoScraping", layout="wide")
st.title("⚽ Tool Scambi Fantacalcio - Dati da Fantacalcio.it (automatico)")
...
# Session state per memorizzare il DataFrame
