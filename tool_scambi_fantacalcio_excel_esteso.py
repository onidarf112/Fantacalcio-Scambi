...
if file_quot and file_stat:
    try:
        ...
        if squadra_a and squadra_b:
            ...
            # 📉 Grafico a barre
            st.subheader("📈 Confronto grafico dei punteggi")
            fig, ax = plt.subplots(figsize=(10, 4))
            ax.barh(labels_a, squadra_a, color="blue", label="Squadra A")
            ax.barh(labels_b, [-x for x in squadra_b], color="red", label="Squadra B")
